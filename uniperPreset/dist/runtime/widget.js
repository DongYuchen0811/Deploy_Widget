...
.columnwidthfixed {
  width: 100px;
}`, "",{"version":3,"sources":["webpack://./your-extensions/widgets/uniperPreset/src/runtime/css/style.css"],"names":[],"mappings":"AAAA;EACE,UAAA;EACA,aAAA;EACA,uBAAA;EACA,YAAA;AACF;;AAEA;EACE,wBAAA;AACF;;AAEA;EACE,YAAA;AACF;;AAEA;EACE,gCAAA;AACF;;AAEA;EACE,WAAA;AACF;;AAEA;EACE,YAAA;AACF","sourcesContent":[".modal {\r\n  width: 30%;\r\n  height: 300px;\r\n  background-color: white;\r\n  margin: auto;\r\n}\r\n\r\n.selection-area{\r\n  display: none !important;\r\n}\r\n\r\ncalcite-card {\r\n  width: 280px;\r\n}\r\n\r\ncalcite-label {\r\n  --calcite-label-margin-bottom: 0;\r\n}\r\n\r\n.columnwidthauto {\r\n  width: auto;\r\n}\r\n\r\n.columnwidthfixed {\r\n  width: 100px;\r\n}"],"sourceRoot":""}]);
// Exports
...
class Widget extends jimu_core__WEBPACK_IMPORTED_MODULE_0__.React.PureComponent {
    constructor(props) {
        ...
        this.saveFilter = (relationId) => {
            ...
            const filterWidgetsArray = widgetsArray.filter(w => w.uri === 'https://dongyuchen0811.github.io/Deploy_Widget/uniperFilter/');
            ...
            if (this.props.useDataSources.length > 0) {
                ...
                (0,_esri_arcgis_rest_feature_layer__WEBPACK_IMPORTED_MODULE_4__.addFeatures)({
                    ...
                    features: [{
                            geometry: { x: 0, y: 0 },
                            attributes: {
                                preset_name: this.state.newFilterName, preset_creator: this.props.user.username,
        ...
        this.unselectAllFilterTabs = () => {
            ...
            const widgetsArray = Object.values(widgets);
            const filterWidgetsArray = widgetsArray.filter(w => w.uri === 'https://dongyuchen0811.github.io/Deploy_Widget/uniperFilter/');
            console.log('All Widget Names:', widgetsArray);
            filterWidgetsArray.forEach(widget => {
                let filterWidgetId = widget.id;
                let widgetState = widgets[filterWidgetId];
                if (widgetState && widgetState.config) {
